          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <div className="w-10 h-10 bg-gray-200 dark:bg-gray-800/50 rounded flex items-center justify-center shrink-0">
                  <svg className="w-5 h-5 text-[#9A1D25]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                  </svg>
                </div>
                <div className="text-sm text-gray-600 dark:text-gray-400">
                  Heroica Ciudad de Puebla<br />de Zaragoza, México
                </div>
              </li>
              <li className="flex items-start gap-3">
                <div className="w-10 h-10 bg-gray-200 dark:bg-gray-800/50 rounded flex items-center justify-center shrink-0">
        ...
        <div className="pt-8 border-t border-gray-200 dark:border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6 text-sm">
              ...
              <Link href="/terms" className="text-gray-600 dark:text-gray-500 hover:text-[#9A1D25] transition-colors">
                Términos
              </Link>
              <a href="#" className="text-gray-600 dark:text-gray-500 hover:text-[#9A1D25] transition-colors">
                Cookies
              </a>
            </div>
            <p className="text-sm text-gray-600 dark:text-gray-500">
